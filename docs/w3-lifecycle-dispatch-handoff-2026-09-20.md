...
| W1→W3 Source 종료 | `contracts/core-runtime/source-retirement-command.schema.json` | `command_id`, `company_id`, `source_id`, 최초 `retired_at`, `target_type`, `target_ref` |
...
- 전체 테스트: `271 passed, 1 skipped`
- lifecycle/retention/core runtime 관련 테스트: `44 passed`
- Ruff lint: 통과
...
1. W1 owner deletion command의 `target_type`에 `W3_CORE_RUNTIME`을 채택하고 위 schema를 pin한다.
